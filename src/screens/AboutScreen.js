  ...
  return (
    <PinchZoomView>
      <ScrollView contentContainerStyle={styles.container}>
        ...
        <Text selectable={true} style={[styles.heading, { fontSize: fontSize + 8, fontWeight: bold ? 'bold' : 'normal' }]}>{isTamil ? 'மந்திரங்கள்' : 'Mantras'}</Text>
        {isTamil ? (
          <>
            <Text selectable={true} style={[styles.body, { fontSize, fontWeight: bold ? 'bold' : 'normal' }]}>
            ...
            <Text selectable={true} style={[styles.body, { fontSize, fontWeight: bold ? 'bold' : 'normal' }]}>
              ...
              {'\n'}மின்னஞ்சல்: <Text selectable={true} style={styles.link} onPress={() => Linking.openURL(`mailto:${EMAIL}`)}>தொடர்பு</Text>
              {'\n'}இருப்பிடம்: Bentonville, Arkansas, USA
              {'\n'}இணையதளம்: <Text selectable={true} style={styles.link} onPress={() => Linking.openURL(WEBSITE)}>பார்க்க</Text>
            </Text>
            <Text selectable={true} style={[styles.body, { fontSize, fontWeight: bold ? 'bold' : 'normal' }]}>
            ...
            <Text selectable={true} style={[styles.body, { fontSize, fontWeight: bold ? 'bold' : 'normal' }]}>
              முழு கொள்கைகள்:
              {'\n'}Privacy Policy: <Text selectable={true} style={styles.link} onPress={() => Linking.openURL(PRIVACY_URL)}>பார்க்க</Text>
              {'\n'}Terms of Use: <Text selectable={true} style={styles.link} onPress={() => Linking.openURL(TERMS_URL)}>பார்க்க</Text>
            </Text>
            ...
            <Text selectable={true} style={[styles.body, { fontSize, fontWeight: bold ? 'bold' : 'normal' }]}>
              📧 Email: <Text selectable={true} style={styles.link} onPress={() => Linking.openURL(`mailto:${EMAIL}`)}>தொடர்பு</Text>
              {'\n'}🌐 Website: <Text selectable={true} style={styles.link} onPress={() => Linking.openURL(WEBSITE)}>பார்க்க</Text>
            </Text>
          </>
        ) : (
          <>
            ...
            <Text selectable={true} style={[styles.body, { fontSize, fontWeight: bold ? 'bold' : 'normal' }]}>
              ...
              {'\n'}Email: <Text selectable={true} style={styles.link} onPress={() => Linking.openURL(`mailto:${EMAIL}`)}>Contact</Text>
              {'\n'}Location: Bentonville, Arkansas, USA
              {'\n'}Website: <Text selectable={true} style={styles.link} onPress={() => Linking.openURL(WEBSITE)}>Facebook</Text>
            </Text>
            <Text selectable={true} style={[styles.body, { fontSize, fontWeight: bold ? 'bold' : 'normal' }]}>
            ...
            <Text selectable={true} style={[styles.body, { fontSize, fontWeight: bold ? 'bold' : 'normal' }]}>
              Full policies:
              {'\n'}Privacy Policy: <Text selectable={true} style={styles.link} onPress={() => Linking.openURL(PRIVACY_URL)}>View</Text>
              {'\n'}Terms of Use: <Text selectable={true} style={styles.link} onPress={() => Linking.openURL(TERMS_URL)}>View</Text>
            </Text>
