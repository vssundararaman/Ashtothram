...
export default function AshtaAiswaryaSidhiManthramScreen() {
  ...
  const heading = language === 'ta' ? 'அஷ்ட ஐஸ்வர்ய சித்தி மந்திரம்' : 'Ashta Aiswarya Sidhi Manthram';
...
const styles = StyleSheet.create({
  ...
  poemLine: { fontSize: 17, marginVertical: 1, textAlign: 'left', alignSelf: 'stretch' },
  accordion: { borderRadius: 8, padding: 10, marginTop: 4 },
  meaningText: { fontSize: 15, marginBottom: 2, textAlign: 'left', alignSelf: 'stretch' },
  blankLine: { height: 8 },
  roundControl: {
    width: 28,
    height: 28,
